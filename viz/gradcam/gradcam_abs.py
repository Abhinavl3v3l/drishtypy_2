...
import drishtypy.viz.gradcam.gradcam_utils as grad_utils
import drishtypy.viz.gradcam.gradcam as gradcam
...
class GradCamAbs():
    ...
    def plot_results(self, images_set, predictions, classesname, save_filename="gradcam_details"):
        ...
        for index, imgs in enumerate(images_set):
            # original image
            title = "T:{}, P:{}".format(classesname[predictions[index]["target"]],
                                        classesname[predictions[index]["pred"]])
